...
// SetPublicIngestURL sets the public-facing OTLP ingest URL surfaced via /health.
func (h *Handler) SetPublicIngestURL(url string) *Handler {
	h.publicIngestURL = url
	return h
}
